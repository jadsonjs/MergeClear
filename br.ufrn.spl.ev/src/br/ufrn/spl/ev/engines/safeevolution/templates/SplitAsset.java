 ...
 *
 */
public abstract class  SplitAsset extends TemplateAnalyzerChain{


	public SplitAsset(RepositoryConnector repositoryConnector, String workDirectory) {
		super(Template.SplitAsset, repositoryConnector, workDirectory);
	}
}
