 ...
 *
 */
public class IprojectLogUtils {

	
	/***
	 * <p>Extract the classes that had changed from the IPROJECT UPDATE LOGS  pattern:</p> 
	 * 
	 * <pre>
	 ...
	 *
	 * @param log the log of the task
	 * @param projectName the project name used to find the class name on the revision path.
	 * @return a list o class change log found in the pattern.
	 */
