...
/**
 * UI for tool settings, edit the file config.properties
 * 
...
public class ToolSettingsUI {
	...
	public ToolSettingsUI(){ }

	public void configure() {
		
		init();
		
		properties = PropertiesUtil.readPropertiesObject(PropertiesUtil.PluginProperties.CONFIG);
	...
	private void createActions() {
		...
		saveButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				PropertiesUtil.writePropertiesObject(PropertiesUtil.PluginProperties.CONFIG, properties);
				shell.dispose();
			}
		});
	}
